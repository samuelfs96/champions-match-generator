  ...
  return (
    <div
      className={`flex justify-between items-center ${
        isFinal ? "bg-[#81209b]" : ""
      } border-[#81209b] border-[1px] max-md:w-full max-md:gap-8 px-8 max-md:px-4 py-4 gap-12 -skew-x-12 [&>*]:skew-x-12`}
    >
      <div className="flex justify-center items-center max-md:w-[80px]">
        <div className="flex items-center flex-col gap-1">
          <img className="w-[62px] h-[62px] max-md:w-[40px] max-md:h-[40px]" src={teamA.logo} alt="teamlogo1" />
      ...
      <div className="flex justify-center items-center max-md:w-[80px]">
        <div className="flex items-center flex-col gap-1">
          <img className="w-[62px] h-[62px] max-md:w-[40px] max-md:h-[40px]" src={teamB.logo} alt="teamlogo2" />
          <h1 className="text-center text-white uppercase text-xs font-semibold">
            {teamB.name}
          </h1>
        </div>
